  ...
  return (
    <div className=" min-h-screen">
      ...
      <main className='min-h-screen   flex flex-col' >
        ...
        <div className='flex flex-wrap  items-center justify-between   min-h-screen px-20'>
       
            <div>
            <img className='h-80'src="/images/avatar.png" alt="" />
        ...
        <div className='px-20 pb-10 '>
            <h1 className='text-4xl text-yellow-400 font-bold text-center'>Codding Profile</h1>
